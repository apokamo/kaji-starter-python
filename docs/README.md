...
| [baseline-check.md](dev/baseline-check.md) | 変更前 pytest artifact・停止基準・regression 比較の正本 |
| [implement-quickref.md](dev/implement-quickref.md) | `/issue-implement` の最小規律と状況別の正本 pointer |
| [workflow_completion_criteria.md](dev/workflow_completion_criteria.md) | workflow 内完了条件・事後確認・各 step の証跡責務 |
